...
SELECT
	e.FirstName + ' ' + ISNULL(MiddleName + ' ', '') + LastName AS [Full Name],
	e.Salary,
...
INSERT INTO Users (UserName, Password, FullName, LastLoginTime, GroupId)
	VALUES ('Peshko', 'blabla', 'Peshko Goshkov', '2015-02-15', 1)

INSERT INTO Users (UserName, Password, FullName, LastLoginTime, GroupId)
	VALUES ('Goshko', 'blabla', 'Goshko Ivanov', '2015-02-14', 2)

INSERT INTO Users (UserName, Password, FullName, LastLoginTime, GroupId)
	VALUES ('Jechka', 'blabla', 'Jechka Petrova', '2015-02-15', 1)
...
INSERT INTO Users
	SELECT
		LOWER(FirstName ) AS UserName,
		LOWER('123456') AS Password,
...
SELECT
	d.Name,
	JobTitle,
	AVG(Salary) AS [Average Employee Salary]
FROM Employees e
JOIN Departments d
	ON d.DepartmentID = e.DepartmentID
GROUP BY	d.Name,
...
INSERT INTO WorkHours (EmployeeId, Date, Task, Hours)
	VALUES (10, GETDATE(), 'Important task', 10)

INSERT INTO WorkHours (EmployeeId, Date, Task, Hours)
	VALUES (11, GETDATE(), 'Very important task', 100)
