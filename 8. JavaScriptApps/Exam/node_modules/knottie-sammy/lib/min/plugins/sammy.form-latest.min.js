...
(function (factory) {
    ...
    $.extend(Sammy.FormBuilder.prototype, {
        open: function (attributes) {
            ...
            var builder = this, keys = $.isArray(keypath) ? keypath : keypath.split(/\./), name = builder.name, value = builder.object, class_name = builder.name;
            ...
            return {name: name, value: getStringContent(builder.object, value), "class": class_name}
        }
    });
    Sammy.Form = function (app) {
        app.helpers({
            simple_element: simple_element, formFor: function (name, object, content_callback) {
                var builder;
